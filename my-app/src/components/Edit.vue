      ...
      <h4>Name</h4>
        ...
        <div class="boton">
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-dark" style="margin-left: 105px; width:90px;" @click="goback">Back</button>
                <button type="button" class="btn btn-success" style="margin-left: 50px" @click="upgrade">Update</button>
            </div>
        </div>
        </form>
    </div>
...
export default{
    ...
    methods:{
        ...
        upgrade(){
            ...
            const path='http://ec2-3-87-68-235.compute-1.amazonaws.com/api/v1/alumnos/'+this.id
            axios.put(path,{
                nombre:this.nombre,
